...
{
	let dzSwitcher = '<div class="sidebar-right">' +
        '<a class="sidebar-right-trigger wave-effect wave-effect-x" href="javascript:void(0)">' +
        '<span><i class="fa fa-cog fa-spin"></i></span></a><div class="sidebar-right-inner">' +
        ...
        '<h4>Dizayn sozlamalari</h4><div><p>Background</p>' +
